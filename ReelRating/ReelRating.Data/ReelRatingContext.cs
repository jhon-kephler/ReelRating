...
namespace ReelRating.Data
{
    public class ReelRatingContext : DbContext
    {
        ...
        public DbSet<Average_Hours> Average_Hours { get; set; }
        public DbSet<Categories> Categories { get; set; }
        public DbSet<Cine> Cine { get; set; }
        public DbSet<Cine_Categories> Cine_Categories { get; set; }
        public DbSet<Comments> Comments { get; set; }
        public DbSet<Customer> Customer { get; set; }
        public DbSet<Customer_Average_Hours> Customer_Average_Hours { get; set; }
        public DbSet<Customer_Whatch> Customer_Whatch { get; set; }
        public DbSet<Favorites> Favorites { get; set; }
        public DbSet<Notes> Notes { get; set; }
        public DbSet<Preferences> Preferences { get; set; }
        public DbSet<Review> Review { get; set; }
        public DbSet<Status> Status { get; set; }
        public DbSet<Type_Cine> Type_Cine { get; set; }
